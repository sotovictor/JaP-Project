  ...
  if (localStorage.getItem("usuario") != null && localStorage.getItem("usuario") != "undefined") {
    document.getElementById("usuario").innerHTML += `<div class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a onclick="clearLocalStorage()" class="dropdown-item" href="login.html">Cerrar cesion</a></li>
                  </ul>
               </div>`
  }
  else {
